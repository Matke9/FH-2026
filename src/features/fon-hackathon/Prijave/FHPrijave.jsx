...
const FHPrijave = () => {
  return (
    <div className="relative w-screen h-screen bg-center bg-cover bg-no-repeat" style={{ backgroundImage: "url('/fh-bg.png')" }}>
      ...
      <div className="flex items-center justify-center w-full h-full">
        <PrijaveLock discipline="fon-hackathon">
          <div className="flex flex-col items-center justify-center w-full max-w-4xl text-center space-y-6">
            {/* StartMenu */}
            <StartMenu discipline="fon-hackathon" />
          </div>
        </PrijaveLock>
      </div>
    </div>
